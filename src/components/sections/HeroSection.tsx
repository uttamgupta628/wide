...
export const HeroSection: React.FC<HeroSectionProps> = ({ heroImg }) => {
  return (
    <section className="px-4 sm:px-6 py-12 sm:py-16 lg:py-20 relative overflow-hidden" style={{ backgroundColor: '#FFDA00' }}>
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row justify-between gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-1/2 relative">
            ...
            <div className="relative px-8 py-10 rounded-lg shadow-xl z-20 w-[95%] -mt-4 ml-8" style={{ backgroundColor: '#FFDA00' }}>
              <span className="absolute top-3 left-3 w-2 h-2 bg-black rounded-full"></span>
              <p className="text-base text-black">widest repertoire of customization</p>
            </div>
            
            <div className="relative px-8 py-10 rounded-lg shadow-lg z-10 w-full -mt-4 ml-4" style={{ backgroundColor: '#FFF4CC' }}>
              <span className="absolute top-3 left-3 w-2 h-2 bg-black rounded-full"></span>
              <p className="text-base text-black">widest repertoire of customization</p>
            </div>
          </div>
