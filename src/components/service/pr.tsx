  ...
  return (
    <div className="bg-[#F8F6F5] min-h-screen">
      ...
      <div className="bg-[#3C3533] text-white text-sm px-6 py-2">
        Home &gt; Services &gt; Public relations
      </div>

      {/* Hero Section */}
      <section className="max-w-7xl mx-auto px-6 py-10">
        <h1 className="text-3xl sm:text-4xl font-bold mb-2">Public relations  (PR)</h1>
        <p className="text-gray-700 mb-6">
          Strategic public realtions services to enhance your brand ‘s reputation and build meaningful connections  with your audience 
        </p>
      ...
      <section className="max-w-7xl mx-auto px-6 py-10">
        ...
        <p className="text-gray-700 mb-8 sm:text-2xl ">
          Effective PR is key to building credibility , managing your public image , and ensuring your brand’s narrative is seen  and heard in the best possible light 
        </p>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/2 flex flex-col justify-start gap-8">
            <h3 className="text-2xl font-semibold">Our Public Relations services</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-16">
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden relative">
            <div className="p-8 pb-16">
              <h4 className="font-bold text-xl mb-4 text-gray-900">Media Expertise</h4>
              <p className="text-gray-600 text-sm leading-relaxed">
                Building strong realtionships with journalists and media outlets
              </p>
            </div>
            {/* Diagonal accent */}
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden relative">
            <div className="p-8 pb-16">
              <h4 className="font-bold text-xl mb-4 text-gray-900">Reputation Management</h4>
              <p className="text-gray-600 text-sm leading-relaxed">
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden relative">
            <div className="p-8 pb-16">
              <h4 className="font-bold text-xl mb-4 text-gray-900">Crisis Management</h4>
              <p className="text-gray-600 text-sm leading-relaxed">
