  ...
  return (
    <div className="bg-[#F8F6F5] min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-6 py-10">
        <h1 className="text-3xl sm:text-4xl font-bold mb-2">Corporate  Events</h1>
        <p className="text-gray-700 mb-6">
          Professional planning and execution of memorable corporate events  that elevate your brand
        </p>
      ...
      <section className="max-w-7xl mx-auto px-6 py-10">
        ...
        <p className="text-gray-700 mb-8 sm:text-2xl ">
          Corporate Events management should  bring manage and lasting impact on your guests and strengthen the brand apoup
with unique  event opportunity last
        </p>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/2 flex flex-col justify-start gap-8">
            <h3 className="text-2xl font-semibold">Our Corporate Event Service</h3>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-600 text-lg mb-12">
          We deliver desirable Where your event start , with creativity best accomplishments
        </p>
